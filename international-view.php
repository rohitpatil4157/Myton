    ...
    <tbody>
      <?php
        ...
        echo '<td><span style=color:#00293c><b>'.$rec[3].'</b></span><br>
         ...
         <span style="text-align:center; margin-left:4px; color:black"> '.$rec[4].'</span></td></tr>
        ';
...
echo ("<script LANGUAGE='JavaScript'>
    ...
    window.location.href='international-view.php?$qs';
    </script>");
}
else{
 mysql_error();
...
<div class="col-md-12">
<h4 style="text-align: left;"><span><i class="fa fa-picture-o"></i> Gallery
</span>
</h4><hr><br></div>
</div>
</div>
