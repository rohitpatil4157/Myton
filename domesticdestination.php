 ...
 <section class="topheader">
  <div class="container">
        <div class="row">
            ...
            <h3 class="mt-4 mb-4 theader">Domestic Holiday - <?php echo $_SERVER['QUERY_STRING']; ?></h3>
...
<div class='card' style='width: 100%;'>
  ...
  <div class='card-body'>
   <a href='domestic-view.php?$pcode'> <h5 class='card-title'>$rec[1]</h5></a>
    <span style='float:right'><i class='fa fa-map-marker'></i> <a href='domesticdestination.php?$rec[9]'>$rec[9]</a></span><br>
